      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
        <div>
          ...
          <p style={{ fontSize: 28, fontWeight: 800, fontVariantNumeric: 'tabular-nums', letterSpacing: '-0.02em', color: '#059669', marginTop: 4 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 500, color: '#94A3B8', marginLeft: 8 }}>of {formatCurrency(totalTarget)}</span>
          </p>
        </div>
              ...
              <div key={goal.id} style={{ ...card, borderTop: `4px solid ${goal.color}`, padding: 24, position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ marginBottom: 12 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                    <span style={{ fontSize: 20, fontWeight: 800, fontVariantNumeric: 'tabular-nums', color: '#0F172A' }}>{formatCurrency(goal.currentAmount)}</span>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 4 }}>
                    <span style={{ fontSize: 11, color: '#94A3B8' }}>{formatCurrency(remaining)} to go</span>
                    <span style={{ fontSize: 11, color: '#94A3B8' }}>Target: {formatCurrency(goal.targetAmount)}</span>
                  </div>
                </div>
